...
- Add bookmarks easily via bookmarklet (prefills title, url, descriptionand tags using meta tags)
- Tags

### Bookmarklet

Add a bookmark to your browser's toolbar with the following script, but replacing the location url with where this web app is hosted:
